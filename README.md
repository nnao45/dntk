...
[![v3.0.19](https://img.shields.io/badge/package-v3.0.19-ff69b4.svg)](https://github.com/nnao45/dntk/releases/tag/v3.0.19)
[![crates](https://img.shields.io/badge/crates.io-v3.0.19-319e8c.svg)](https://crates.io/crates/dntk)
[![docker](https://img.shields.io/badge/docker-v3.0.19-blue.svg)](https://hub.docker.com/r/nnao45/dntk/tags?name=v3.0.19)
...
## ***Current dntk's version:v3.0.19***
...
### Linux
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v3.0.19/dntk-v3.0.19-x86_64-unknown-linux-musl.zip
$ unzip dntk-v3.0.19-x86_64-unknown-linux-musl.zip
```

### Windows
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v3.0.19/dntk-v3.0.19-x86_64-pc-windows-msvc.zip
$ unzip dntk-v3.0.19-x86_64-pc-windows-msvc.zip
```

### FreeBSD
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v3.0.19/dntk-v3.0.19-x86_64-unknown-freebsd.zip
$ unzip dntk-v3.0.19-x86_64-unknown-freebsd.zip
```
...
### Previous versions (v3.0.19 and earlier)
