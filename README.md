...
[![v2.1.7](https://img.shields.io/badge/package-v2.1.7-ff69b4.svg)](https://github.com/nnao45/dntk/releases/tag/v2.1.7)
...
### Linux
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v2.1.7/dntk-v2.1.7-x86_64-unknown-linux-gnu.zip
$ unzip dntk-v2.1.7-x86_64-unknown-linux-gnu.zip
```

if can't move, try...
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v2.1.7/dntk-v2.1.7-x86_64-unknown-linux-musl.zip
$ unzip dntk-v2.1.7-x86_64-unknown-linux-musl.zip
```

### Windows
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v2.1.7/dntk-v2.1.7-x86_64-pc-windows-msvc.zip
$ unzip dntk-v2.1.7-x86_64-pc-windows-msvc.zip
```
