...
[![v1.0.7](https://img.shields.io/badge/package-v1.0.7-ff69b4.svg)](https://github.com/nnao45/dntk/releases/tag/v1.0.7)
...
### Linux
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v1.0.7/dntk-linux-amd64-v1.0.7.tar.gz
$ tar xvfz dntk-linux-amd64-v1.0.7.tar.gz
```
