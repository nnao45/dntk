...
[![2.1.12](https://img.shields.io/badge/package-2.1.12-ff69b4.svg)](https://github.com/nnao45/dntk/releases/tag/2.1.12)
[![crates](https://img.shields.io/badge/crates.io-2.1.12-319e8c.svg)](https://crates.io/crates/dntk)
[![docker](https://img.shields.io/badge/docker-2.1.12-blue.svg)](https://hub.docker.com/r/nnao45/dntk/tags)
...
### Linux
```bash
$ wget https://github.com/nnao45/dntk/releases/download/2.1.12/dntk-2.1.12-x86_64-unknown-linux-gnu.zip
$ unzip dntk-2.1.12-x86_64-unknown-linux-gnu.zip
```

if can't move, try...
```bash
$ wget https://github.com/nnao45/dntk/releases/download/2.1.12/dntk-2.1.12-x86_64-unknown-linux-musl.zip
$ unzip dntk-2.1.12-x86_64-unknown-linux-musl.zip
```

### Windows
```bash
$ wget https://github.com/nnao45/dntk/releases/download/2.1.12/dntk-2.1.12-x86_64-pc-windows-msvc.zip
$ unzip dntk-2.1.12-x86_64-pc-windows-msvc.zip
```
