...
[![v2.0.4](https://img.shields.io/badge/package-v2.0.4-ff69b4.svg)](https://github.com/nnao45/dntk/releases/tag/v2.0.4)
[![crates](https://img.shields.io/badge/crates.io-v2.0.4-319e8c.svg)](https://crates.io/crates/dntk)
[![docker](https://img.shields.io/badge/docker-v2.0.4-blue.svg)](https://hub.docker.com/r/nnao45/dntk/tags)
...
### Linux
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v2.0.4/dntk-v2.0.4-x86_64-unknown-linux-gnu.zip
$ unzip dntk-v2.0.4-x86_64-unknown-linux-gnu.zip
```

if can't move, try...
```bash
$ wget https://github.com/nnao45/dntk/releases/download/v2.0.4/dntk-v2.0.4-x86_64-unknown-linux-musl.zip
$ unzip dntk-v2.0.4-x86_64-unknown-linux-musl.zip
```
